...
class PayoutOrdersApi:
    ...
    def get_payout_order_by_id(
        ...
        _param = self._get_payout_order_by_id_serialize(
            id=id,
            accept_language=accept_language,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_payout_order_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_payout_order_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Identifier of the resource")],
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        _request_timeout: Union[
    ...
    def _get_payout_order_by_id_serialize(
        self,
        id,
        accept_language,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/payout_orders/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_payout_orders(
        ...
        _param = self._get_payout_orders_serialize(
            accept_language=accept_language,
            limit=limit,
            search=search,
            next=next,
    ...
    @validate_call
    def get_payout_orders_with_http_info(
        self,
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=1)]], Field(description="The numbers of items to return, the maximum value is 250")] = None,
        search: Annotated[Optional[StrictStr], Field(description="General order search, e.g. by mail, reference etc.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PayoutOrdersResponse]:
        """Get a list of Payout Orders
    ...
    @validate_call
    def get_payout_orders_without_preload_content(
        self,
        accept_language: Annotated[Optional[StrictStr], Field(description="Use for knowing which language to use")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=1)]], Field(description="The numbers of items to return, the maximum value is 250")] = None,
        search: Annotated[Optional[StrictStr], Field(description="General order search, e.g. by mail, reference etc.")] = None,
    ...
    def _get_payout_orders_serialize(
        self,
        accept_language,
        limit,
        search,
