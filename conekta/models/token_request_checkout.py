...
class TokenRequestCheckout(BaseModel):
    """
    TokenRequestCheckout
    """ # noqa: E501
    returns_control_on: Optional[StrictStr] = Field(default=None, description="It is a value that allows identifying the returns control on.", json_schema_extra={"examples": ["Token"]})
