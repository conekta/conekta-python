...
class OrderRequest(BaseModel):
    ...
    """
    charges: Optional[List[ChargeRequest]] = Field(None, description="List of [charges](https://developers.conekta.com/v2.1.0/reference/orderscreatecharge) that are applied to the order")
    ...
    discount_lines: Optional[List[OrderDiscountLinesRequest]] = Field(None, description="List of [discounts](https://developers.conekta.com/v2.1.0/reference/orderscreatediscountline) that are applied to the order. You must have at least one discount.")
    ...
    shipping_lines: Optional[List[ShippingRequest]] = Field(None, description="List of [shipping costs](https://developers.conekta.com/v2.1.0/reference/orderscreateshipping). If the online store offers digital products.")
    tax_lines: Optional[List[OrderTaxRequest]] = Field(None, description="List of [taxes](https://developers.conekta.com/v2.1.0/reference/orderscreatetaxes) that are applied to the order.")
