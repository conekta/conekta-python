...
class ResendEventRequest(BaseModel):
    """
    ResendEventRequest
    """ # noqa: E501
    webhooks_ids: List[StrictStr] = Field(description="webhooks ids to resend event", json_schema_extra={"examples": [["6307a60c41de27127515a575", "6307a60c41de27127515a571"]]})
