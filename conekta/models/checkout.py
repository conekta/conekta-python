...
class Checkout(BaseModel):
    ...
    """ # noqa: E501
    allowed_payment_methods: Optional[List[StrictStr]] = Field(default=None, description="Those are the payment methods that will be available for the link. This field is mutually exclusive with excluded_payment_methods.", json_schema_extra={"examples": [["cash", "card", "bank_transfer", "bnpl", "pay_by_bank"]]})
    ...
    __properties: ClassVar[List[str]] = ["allowed_payment_methods", "excluded_payment_methods", "exclude_card_networks", "expires_at", "monthly_installments_enabled", "monthly_installments_options", "three_ds_mode", "name", "needs_shipping_contact", "on_demand_enabled", "plan_ids", "order_template", "payments_limit_count", "success_url", "recurrent", "type"]
