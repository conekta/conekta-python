...
class Checkout(BaseModel):
    ...
    monthly_installments_options: Optional[List[StrictInt]] = Field(None, description="This field allows you to specify the number of months without interest.")
    ...
    def to_dict(self):
        ...
        if self.on_demand_enabled is None:
