...
class FiscalEntityRequestAddress(BaseModel):
    """
    FiscalEntityRequestAddress
    """ # noqa: E501
    street1: StrictStr = Field(json_schema_extra={"examples": ["Nuevo Leon 254"]})
    street2: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Departamento 404"]})
    postal_code: StrictStr = Field(json_schema_extra={"examples": ["06100"]})
    city: StrictStr = Field(json_schema_extra={"examples": ["Ciudad de Mexico"]})
    state: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["Ciudad de Mexico"]})
    country: Optional[StrictStr] = Field(default=None, description="this field follows the [ISO 3166-1 alpha-2 standard](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)", json_schema_extra={"examples": ["MX"]})
    residential: Optional[StrictBool] = Field(default=False, json_schema_extra={"examples": [True]})
