...
class PaymentMethodTokenRequest(BaseModel):
    ...
    token_id: StrictStr = Field(description="Token id that will be used to create a \"card\" type payment method. See the (subscriptions)[https://developers.conekta.com/v2.2.0/reference/createsubscription] tutorial for more information on how to tokenize cards.", json_schema_extra={"examples": ["tok_32hj4g234as"]})
