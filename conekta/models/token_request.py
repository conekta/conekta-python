...
class TokenRequest(BaseModel):
    ...
    a token
    """ # noqa: E501
    card: Optional[TokenRequestCard] = None
    checkout: Optional[TokenRequestCheckout] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "card": TokenRequestCard.from_dict(obj["card"]) if obj.get("card") is not None else None,
            "checkout": TokenRequestCheckout.from_dict(obj["checkout"]) if obj.get("checkout") is not None else None
        })
        return _obj
