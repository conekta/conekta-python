...
class UpdateCustomer(BaseModel):
    ...
    email: Optional[StrictStr] = Field(default=None, description="An email address is a series of customizable characters followed by a universal Internet symbol, the at symbol (@), the name of a host server, and a web domain ending (.mx, .com, .org, . net, etc).", json_schema_extra={"examples": ["miguel@gmail.com"]})
    name: Optional[StrictStr] = Field(default=None, description="Client's name", json_schema_extra={"examples": ["miguel"]})
    phone: Optional[StrictStr] = Field(default=None, description="Is the customer's phone number", json_schema_extra={"examples": ["+5215555555555"]})
