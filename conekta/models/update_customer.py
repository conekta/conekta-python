...
class UpdateCustomer(BaseModel):
    ...
    payment_sources: Optional[List[CustomerPaymentMethodsRequest]] = Field(None, description="Contains details of the payment methods that the customer has active or has used in Conekta")
    shipping_contacts: Optional[List[CustomerShippingContacts]] = Field(None, description="Contains the detail of the shipping addresses that the client has active or has used in Conekta")
    ...
    def to_dict(self):
        ...
        if self.antifraud_info is None:
