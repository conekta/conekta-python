...
class LogResponseForRequest(BaseModel):
    """
    log model
    """ # noqa: E501
    created_at: StrictInt = Field(json_schema_extra={"examples": [1661445644]})
    id: StrictStr = Field(json_schema_extra={"examples": ["6307a60c41de27127515a575"]})
    ...
    request_headers: Optional[Any] = Field(default=None, json_schema_extra={"examples": [{"Accept": "application/vnd.conekta-v2.3.0+json", "Accept-Encoding": "gzip, deflate, br", "Accept-Language": "es-419, es; q=0.9, en; q=0.8", "Activitypermission": "orders:read", "Apiversion": "2.3.0"}]})
    ...
    version: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["2.3.0"]})
